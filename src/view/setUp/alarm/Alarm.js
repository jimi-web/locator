        ...
        return <ScrollView style={[this.props.style,{marginTop:15,flex:1}]}>
            {
                ...
                <View style={{marginBottom:15,backgounrdColor:'#F7F7F7'}}>
                 <ListRow 
                    ...
                    title={<View style={{marginLeft:7,width:200}}>
                        <Text style={{fontSize:14}}>{I18n.t('告警接收')}</Text>
                        <Text style={{color:'#A3A3A3',fontSize:11,marginTop:5}}>{I18n.t('关闭后，App将不再接收所有告警信息')}</Text>
                    </View>} 
                ...
                </View>
            {
                this.state.enabledFlag?
                    this.state.alarmList.map((item,index)=>{
                        return  <View><ListRow 
                        key={'alarm'+index}
                        title={<View style={{marginLeft:7,width:250}}>
                                <Text style={{fontSize:16}}>{I18n.t(item.alarmCode)}</Text>
                            </View>} 
